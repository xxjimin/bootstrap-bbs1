<template>
    <div>
        <b-card>
            <div class="content-detail_content-info">
                ...
                <div class="content-detail_content-info-right">
                    <div class="content-detail_content-info-right-user">
                        글쓴이: {{user}}
                    </div>
                    <div class="content-detail_content-info-right-created">
                        등록일: {{created}}
                    </div>
                </div>
